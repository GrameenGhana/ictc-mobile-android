...
public class APIController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (serviceCode.equalsIgnoreCase("cmeeting")) {
                jSONObject = processMeeting(request.getParameter("crop"));
                ...
                jSONObject.put("rc", "05");
                jSONObject.put("msg", "Invalid Action");
                out.print(jSONObject);
            }
        }
    }

    // <editor-fold defaultstate="collapsed" desc="API methods. Click on the + sign on the left to edit the code.">
    ...
    //<editor-fold defaultstate="collapsed" desc="Meetings API">

    private JSONObject processMeeting(String crop) {
...
//                  obj.put(MeetingSetting.CROP, meetingSetting.getCrop());
                    ...
                    obj.put("activity", createMeetingActivities(meetingSetting));
                    meetSet.put(obj);
                }
    ...
    private JSONArray createMeetingActivities(MeetingSettingWrapper msw) {
        JSONArray ja = new JSONArray();
        for (MeetingActivityWrapper aw : msw.getMeetingActivities()) {
    ...
    //<editor-fold defaultstate="collapsed" desc="Update Farmer">

    private JSONArray updateFarmer() {
    ...
    //<editor-fold defaultstate="collapsed" desc="Map API">

    private JSONObject processMap(String res, String farmer) {
        ...
        JSONArray ja = j.getJSONArray("points");
    ...
    //<editor-fold defaultstate="collapsed" desc="Sync Data">

    private JSONObject syncData(String data) {
    ...
    //<editor-fold defaultstate="collapsed" desc="Update Details">

    private JSONArray updateDetails(String agentId, String lm) {
        long lastMdate = 0;
