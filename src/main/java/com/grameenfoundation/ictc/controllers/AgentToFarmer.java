 ...
 * @author grameen
 */
@WebServlet(name = "AgentToFarmer", urlPatterns = {"/agent/assignfarmer"})
public class AgentToFarmer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String[] farmers = request.getParameterValues("farmer");
            ...
            for (String farmer : farmers) {
                ...
                System.out.println("farmer " + farmer);
                 System.out.println(bio.BiodataUpdate(farmer, update));
