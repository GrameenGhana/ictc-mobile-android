 ...
 * @date Sep 25, 2015 11:38:48 AM
 * description:
 */
public class PostHarvestWrapper2 {
    ...
    String otherapplicationrate="otherapplicationrate";
    ...
    String proportionformarket="proportionformarket";
    String proportionofcassavaprocessedintochips="proportionofcassavaprocessedintochips";
    String therapplicationrateofstoragechemic="therapplicationrateofstoragechemic";
    String typeofbagusedinbulkingproduct="typeofbagusedinbulkingproduct";
 ...
 public  void setTypeofmachinewinowing(String typeofmachinewinowing) {
      this.typeofmachinewinowing=typeofmachinewinowing;
    }
 public  String getTypeofmachinewinowing() {
        return typeofmachinewinowing;
 ...
 public  void setOtherapplicationrate(String otherapplicationrate) {
      this.otherapplicationrate=otherapplicationrate;
    }
 public  String getOtherapplicationrate() {
        return otherapplicationrate;
