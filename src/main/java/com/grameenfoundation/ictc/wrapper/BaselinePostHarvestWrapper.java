 ...
 * @date Oct 13, 2015 12:58:15 PM
 * description:
 */
public class BaselinePostHarvestWrapper {
    
    
    String applicationrateofstoragechemical="applicationrateofstoragechemical";
    String completionofproducemarketing="completionofproducemarketing";
    String completionofthreshing="completionofthreshing";
    String dateofcompletingdrying="dateofcompletingdrying";
    String datetocompletedrying="datetocompletedrying";
    String dehuskingdate="dehuskingdate";
    String firstsaledate="firstsaledate";
    String mainpointofsaleorcontact="mainpointofsaleorcontact";
    String manualthreshing="manualthreshing";
    String manualwinnowing="manualwinnowing";
    String marketingoccasions="marketingoccasions";
    String methodofdryingcobspanicleschipschu="methodofdryingcobspanicleschipschu";
    String methodofdryinggrain="methodofdryinggrain";
    String methodofprocessingdehusking="methodofprocessingdehusking";
    String methodofthreshing="methodofthreshing";
    String methodofwinnowing="methodofwinnowing";
    String mostproducesaledate="mostproducesaledate";
    String othermethodfordrying="othermethodfordrying";
    String othermethodofdryinggrain="othermethodofdryinggrain";
    String othermethodsofdehusking="othermethodsofdehusking";
    String othersalecontact="othersalecontact";
    String otherstoragechemical="otherstoragechemical";
    String ownershiporconditionsforstorage="ownershiporconditionsforstorage";
    String postharvestlosses="postharvestlosses";
    String priceatfirstsaledate="priceatfirstsaledate";
    String priceatmostsaledate="priceatmostsaledate";
    String processingofcassava="processingofcassava";
    String proportionofcassava="proportionofcassava";
    String proportionofproducesold="proportionofproducesold";
    String typeofbagcontainerused="typeofbagcontainerused";
    String typeofmachine="typeofmachine";
    String typeofmachinewinonowing="typeofmachinewinonowing";
 ...
 public  String getWhatcropareyouplanningtocultivate() {
        return whatcropareyouplanningtocultivate;
 ...
 public  void setTypeofstoragechemical(String typeofstoragechemical) {
      this.typeofstoragechemical=typeofstoragechemical;
    }
 public  String getTypeofstoragechemical() {
        return typeofstoragechemical;
 ...
 public  void setTypeofmachinewinonowing(String typeofmachinewinonowing) {
      this.typeofmachinewinonowing=typeofmachinewinonowing;
    }
 public  String getTypeofmachinewinonowing() {
        return typeofmachinewinonowing;
 ...
 public  void setMethodofprocessingdehusking(String methodofprocessingdehusking) {
      this.methodofprocessingdehusking=methodofprocessingdehusking;
    }
 public  String getMethodofprocessingdehusking() {
        return methodofprocessingdehusking;
