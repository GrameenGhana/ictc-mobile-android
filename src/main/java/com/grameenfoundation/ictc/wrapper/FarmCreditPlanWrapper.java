 ...
 * @date Mar 9, 2016 4:56:30 PM
 * description:
 */
public class FarmCreditPlanWrapper {
    
    
String creditactualc="creditactualc";
String creditcashpaybackexpectedc="creditcashpaybackexpectedc";
String creditcashreceivedquantumc="creditcashreceivedquantumc";
String creditinorganicfertilizerc="creditinorganicfertilizerc";
String creditmodec="creditmodec";
String creditortypeotherc="creditortypeotherc";
String creditpaybackgeneralmodec="creditpaybackgeneralmodec";
String creditploughingc="creditploughingc";
String creditpostplantherbicidec="creditpostplantherbicidec";
String creditpreplantherbicidec="creditpreplantherbicidec";
String creditproducepaybackexpectedc="creditproducepaybackexpectedc";
String creditproducestoragec="creditproducestoragec";
String creditseedc="creditseedc";
String creditthreshingc="creditthreshingc";
String credittransportc="credittransportc";
String credittypec="credittypec";
String gpslocationplancredit_="gpslocationplancredit";
String paybackquantumfertilizerc="paybackquantumfertilizerc";
String paybackquantumploughc="paybackquantumploughc";
String paybackquantumpostherbc="paybackquantumpostherbc";
String paybackquantumpreplantherbc="paybackquantumpreplantherbc";
String paybackquantumseedc="paybackquantumseedc";
String paybackquantumstoragec="paybackquantumstoragec";
String paybackquantumthreshingc="paybackquantumthreshingc";
String paybackquantumtransportc="paybackquantumtransportc";
String plannedpaybackmode="plannedpaybackmode";
