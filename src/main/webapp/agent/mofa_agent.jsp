<%-- 
    Document   : mofa_agent
    Created on : Mar 30, 2016, 12:00:08 PM
...
<html>
    <head>
        ...
        <%
            ...
            List<AgentWrapper> agents = agentModel.findAllMOFAAgents();
    ...
    <body>
         <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a href="<%=request.getContextPath() %>/agent/editagent.jsp?type=CreatedById&q=<%=ag.getAgentId() %>" class="btn btn-info">Assign Farmer(s) </a>
                </td>
            </tr>
            <% }%>
         </table>
