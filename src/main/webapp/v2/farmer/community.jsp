...
<%  BiodataModel biodataModel = new BiodataModel();
    List<BiodataWrapper> bioWrapper = biodataModel.getBioDataSearch(Biodata.COMMUNITY,request.getParameter("community"));
%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Farmers in  <%=request.getParameter("community") %></title>
