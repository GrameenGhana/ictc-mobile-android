<%-- 
    Document   : mofa
    Created on : Mar 23, 2016, 4:14:30 PM
                        ...
                        <div class="widget-content">
                            ...
                            <div id="big_stats" class="cf">
                                <div class="stat"> <i class="icon-anchor"></i>
                                    ...
                                    <span class="value"><a href="<%=request.getContextPath() %>/farmer/mofafarmer.jsp"><%=bioModel.getMOFAFarmerCount() %></a></span> 
                                ...
                                <div class="stat">
                                    <i class="icon-twitter-sign"></i> <span class="value">
                                        <a href="<%=request.getContextPath() %>/agent/mofa_agent.jsp"><%=bioModel.getMOFAAgentCount() %> </a></span>    
                                    <div>Agents</div>
