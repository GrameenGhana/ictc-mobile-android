...
<html>
        ...
        <div class="span6">
            <div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">Farm Management Plan</div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="settings">Farmer Location</div>
                </div>
    ...
    <script type="text/javascript">
        //    alert('mapping')
          loadGoogleMap("mmapview", '', "<%=wrapper.getFirstName() + " " + wrapper.getLastName()%>")
    </script>
</html>
